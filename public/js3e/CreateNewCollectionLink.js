...
export default function CreateNewLink(props){
    ...
    return(<>
        ...
        {collectionData == false ? "" : <Content collectionData={collectionData} formText={formText} handleText={handleText} />}
...
function UrlPreview(props){
    let domainURL = `${props.collectionData.collectionUrl}`.match(/^(?:\/\/|[^\/]+)*/)[0];
    let slug = `${props.collectionData.collectionUrl}`.match(/[^\/]+$/)[0];
    console.log(domainURL)
    // redirect=%2Fcollections%2Fadidas-classic-backpack
            ...
            <div className="col-md-6">
                <div className="main-card mb-3 card">
                    <div className="card-body">
                        ...
                        <UrlPreview collectionData={props.collectionData} formText={props.formText} />
